...
public final class WindowState
{
  ...
  /** The default zip file. */
  // private String zipFile = null;
  
  /** The directory for the zip file. */
...
//  
//  
//  public void setZipFile(final String filename)
//  {
//    zipFile = filename;
//  }
  ...
  public void setZipDir(final String dirname)
  {
    zipDir = dirname;
  }
  ...
  public static void load(final String filename)
  {
    ...
    // Get the directory for the zip file
    val = props.getProperty("zip.dir");
    if ((val != null) && (val.length() > 0))
    {
      ws.zipDir = val.trim();
    }
